...
class SpiderSolitaireNextMoves():
    ...
    def get_valid_moves(spider_game):
        ...
        valid_moves=SpiderSolitaireNextMoves.remove_moves_between_empty_piles(spider_game, valid_moves)
        valid_moves=SpiderSolitaireNextMoves.remove_moves_to_multiple_empty_piles(spider_game, valid_moves)
        valid_moves=SpiderSolitaireNextMoves.remove_moves_to_same(spider_game, valid_moves)
        # add the deal move
    ...
    def apply_random_move(spider_game):
        valid_moves = SpiderSolitaireNextMoves.get_valid_moves(spider_game)
        if valid_moves:
