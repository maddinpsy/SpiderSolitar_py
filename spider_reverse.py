...
class SpiderSolitaireReverse:
    ...
    def do_reverse_basic_move(spider_game, source_idx = None):
        ...
        if source_idx is None:
            ...
            src_piles_idx = [idx for idx in src_piles_idx if SpiderSolitaireReverse.max_cards_placed(spider_game.tableau[idx])>0]
        ...
        number_of_cards = random.randint(1, SpiderSolitaireReverse.max_cards_placed(pile))
    ...
    def do_reverse_deal(spider_game):
        ...
        for pile in spider_game.tableau:
            ...
            if SpiderSolitaireReverse.max_cards_placed(pile) > 0:
    ...
    def do_random_reverse_move(spider_game):
        ...
        move = SpiderSolitaireReverse.do_reverse_deal(spider_game)
        if move is not None:
            return move
        
        unstack_idx = SpiderSolitaireReverse.undo_remove_full_sequence(spider_game)

        move = SpiderSolitaireReverse.do_reverse_basic_move(spider_game, unstack_idx)
